...
const uint32_t res2hNrOfFiles = 52;
...
res2hMapType::value_type mapTemp[] = {
    ...
    std::make_pair(":/help/button_y.svg", res2hFiles[33]),
    std::make_pair(":/help/joystick_left.svg", res2hFiles[34]),
    std::make_pair(":/help/button_l.svg", res2hFiles[35]),
    std::make_pair(":/help/button_l3.svg", res2hFiles[36]),
    std::make_pair(":/help/dpad_updown.svg", res2hFiles[37]),
    std::make_pair(":/help/dpad_all.svg", res2hFiles[38]),
    std::make_pair(":/help/dpad_left.svg", res2hFiles[39]),
    std::make_pair(":/help/button_b.svg", res2hFiles[40]),
    std::make_pair(":/help/dpad_right.svg", res2hFiles[41]),
    std::make_pair(":/help/button_r.svg", res2hFiles[42]),
    std::make_pair(":/help/dpad_leftright.svg", res2hFiles[43]),
    std::make_pair(":/help/button_l2.svg", res2hFiles[44]),
    std::make_pair(":/help/button_r2.svg", res2hFiles[45]),
    std::make_pair(":/help/dpad_up.svg", res2hFiles[46]),
    std::make_pair(":/help/button_select.svg", res2hFiles[47]),
    std::make_pair(":/help/button_a.svg", res2hFiles[48]),
    std::make_pair(":/help/button_start.svg", res2hFiles[49]),
    std::make_pair(":/help/button_r3.svg", res2hFiles[50]),
