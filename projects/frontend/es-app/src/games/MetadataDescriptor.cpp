  ...
  switch(type)
  {
    case ItemType::Game:
    {
      ...
      static const MetadataFieldDescriptor sGameMetadataDescriptors[] =
      {
        ...
        MetadataFieldDescriptor("lastPatch"  , DefaultValueEmpty    , _("Last Patch")  , _("enter patch")                 , (int)offsetof(MetadataDescriptor, mLastPatch)  , MetadataFieldDescriptor::DataType::Path  , MetadataFieldDescriptor::EditableType::Text   , &MetadataDescriptor::IsDefaultLastPath       , &MetadataDescriptor::LastPatchAsString   , &MetadataDescriptor::SetLastPatchAsString    , true , false),
      };
