  ...
  switch(type)
  {
    case ItemType::Game:
    {
      static const MetadataFieldDescriptor sGameMetadataDescriptors[] =
      {
        ...
        MetadataFieldDescriptor("rotation"   , DefaultValueRotation , _("Rotation")    , _("enter rotation")              , MetadataFieldDescriptor::DataType::Int , MetadataFieldDescriptor::EditableType::None   , &MetadataDescriptor::IsDefaultRotation       , &MetadataDescriptor::RotationAsString    , &MetadataDescriptor::SetRotationAsString     , false , false),
      };
