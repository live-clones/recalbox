  ...
  switch(type)
  {
    case ItemType::Game:
    {
      ...
      static const MetadataFieldDescriptor _GameMetadataDescriptors[] =
      {
        ...
        MetadataFieldDescriptor("core"       , DefaultValueEmpty    , _("Core")        , _("enter core")                  , (int)offsetof(MetadataDescriptor, _Core)       , MetadataFieldDescriptor::DataType::PList  , MetadataFieldDescriptor::EditableType::List   , &MetadataDescriptor::IsDefaultCore           , &MetadataDescriptor::CoreAsString        , &MetadataDescriptor::SetCore                 , false, true),
