  ...
  , mSystemManager(systemManager)
{
  ...
  // show savestates
  mShowSaveStates = AddSwitch(_("SHOW SAVE STATES"), RecalboxConf::Instance().GetGlobalShowSaveStateBeforeRun(), (int)Components::ShowSaveStates, this, Strings::Empty);
...
void GuiMenuGameSettings::SwitchComponentChanged(int id, bool status)
{
  switch((Components)id)
  {
    ...
    case Components::ShowSaveStates: RecalboxConf::Instance().SetGlobalShowSaveStateBeforeRun(status).Save(); break;
