...
public:
    ...
    static const std::string UPDATE_CHANGELOG_HELP_MSG;
    ...
    static const std::string GAMELISTOPTION_JUMP_LETTER;
	static const std::string GAMELISTOPTION_SORT_GAMES;
	static const std::string GAMELISTOPTION_FAVORITES_ONLY;
	static const std::string GAMELISTOPTION_SHOW_HIDDEN;
	static const std::string GAMELISTOPTION_EDIT_METADATA;
};
