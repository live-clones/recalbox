                      ...
                      , public IScraperEngineStage
{
  ...
  private:
    ...
    std::string GetLogin() const override { return Strings::Trim(mConfiguration.GetRecalboxScraperLogin()); }

    //! Get screenscraper password
    std::string GetPassword() const override { return Strings::Trim(mConfiguration.GetRecalboxScraperPassword()); }
