...
#include <scraping/scrapers/screenscraper/endpoints/RecalboxEndPoints.h>
                      ...
                      , public IScraperEngineStage
{
  public:
    ...
    static constexpr int sScrappingEngineCount = 8;
    ...
    /*!
     * @brief Push a new candidate to scrapping
  ...
  private:
    ...
    //! Scraping "engines"
    ScreenScraperSingleEngine mEngines[sScrappingEngineCount];
    ...
    int AllocateEngine()
    {
      ...
      for(int i = sScrappingEngineCount; --i >= 0;)
    ...
    std::string GetLogin() const override { return mConfiguration.GetRecalboxScraperLogin(); }

    //! Get screenscraper password
    std::string GetPassword() const override { return mConfiguration.GetRecalboxScraperPassword(); }

    //! Get favorite language
    Languages GetFavoriteLanguage() const override { return mConfiguration.GetScreenScraperLanguage(); };
