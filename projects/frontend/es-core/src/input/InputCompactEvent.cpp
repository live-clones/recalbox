...
const InputCompactEvent InputCompactEvent::Rotate(const InputCompactEvent& toRotate)
{
  ...
  swap(event.mActivatedEntryFlags,21,24);
  swap(event.mActivatedEntryFlags,21,22);
  swap(event.mActivatedEntryFlags,23,21);
  ...
  swap(event.mDeactivatedEntryFlags,21,22);
  swap(event.mDeactivatedEntryFlags,23,21);
  return event;
}
