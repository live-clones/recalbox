...
Settings::DataDescriptor Settings::sDescriptors[] =
{
  ...
  { Settings::DataType::String, offsetof(Settings::Data, mInputName[4]              ), "INPUT P4NAME"               , "DEFAULT"                                                  , false },
  ...
  { Settings::DataType::String, offsetof(Settings::Data, mInputGuid[4]              ), "INPUT P4GUID"               , ""                                                  , false },
