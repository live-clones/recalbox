...
#define ICON_TEXT_SPACING std::max(Renderer::getScreenWidth() * 0.004f, 4.0f) // space between [icon] and [text] (px)
#define ENTRY_SPACING std::max(Renderer::getScreenWidth() * 0.008f, 4.0f) // space between [text] and next [icon] (px)
