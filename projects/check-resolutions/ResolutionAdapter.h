...
class ResolutionAdapter
{
  public:
    ...
    //! Get resolution list
    static const ResolutionList& GetResolutionList();

    //! Adjust the given resolution to the best matching available resolution
    static bool AdjustResolution(int display, const std::string& value, const ResolutionList& list, Resolutions::SimpleResolution& output);
};
