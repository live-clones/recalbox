...
emulators["gba"] = Emulator(name='gba', emulator='libretro', core='mgba')
...
emulators["mame"] = Emulator(name='mame', emulator='libretro', core='mame2003_plus')
...
emulators["x1"] = Emulator(name='x1', emulator='libretro', core='xmil')
...
emulators["palm"] = Emulator(name='palm', emulator='libretro', core='mu')
