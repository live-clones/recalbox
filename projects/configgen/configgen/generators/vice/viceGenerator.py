...
class ViceGenerator(Generator):
    ...
    def generate(self, system: Emulator, playersControllers: ControllerPerPlayer, recalboxOptions: keyValueSettings, args) -> Command:
        ...
        commandArray = ["/usr/bin/vice/" + coreToRun,
                        ...
                        "-addconfig", overrideSettings.getSettingsFile(),
                        "-autostart", args.rom]
    ...
    def SetJoystickFile(self, rom: str,playersControllers: ControllerPerPlayer):
        ...
        if os.path.exists(sourcevjm):
            ...
            c64joystick: int = 1
            for player, controller in playersControllers:
                ...
                if player == 1:
                    ...
                    if controller.HasHotkey and controller.Hotkey.IsButton: lines.append("{} 1 {} 5 Quit emulator".format(controller.SdlIndex, controller.HasHotkey.Id)) # HK = Quit emulator
            ...
            with open(self.VICE_JOYSTICK_MAPPING, 'w') as destinationfile:
                destinationfile.writelines(lines)