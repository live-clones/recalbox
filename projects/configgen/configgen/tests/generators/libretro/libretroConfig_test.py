...
class TestLibretroConfig(unittest.TestCase):
    ...
    def test_smooth_override_defaut_and_global(self):
        ...
        builder = libretroConfigurations.LibretroConfiguration(self.snes, self.onePlayerController, "/rom.rom", False, False, keyValueSettings("", False))
    ...
    def test_create_with_ratio_169(self):
        builder = libretroConfigurations.LibretroConfiguration(self.nes, self.onePlayerController, "/rom.rom", False, False, keyValueSettings("", False))
        builder.overrideLibretroConfigurationFiles(None, self.retroarchcustomFile)
        retroconf, retroover = builder.createRetroarchConfiguration()
    ...
    def test_create_with_ratio_43(self):
        builder = libretroConfigurations.LibretroConfiguration(self.nes43, self.onePlayerController, "/rom.rom", False, False, keyValueSettings("", False))
        builder.overrideLibretroConfigurationFiles(None, self.retroarchcustomFile)
        retroconf, retroover = builder.createRetroarchConfiguration()
    ...
    def test_create_with_ratio_auto(self):
        builder = libretroConfigurations.LibretroConfiguration(self.nesauto, self.onePlayerController, "/rom.rom", False, False, keyValueSettings("", False))
        builder.overrideLibretroConfigurationFiles(None, self.retroarchcustomFile)
        retroconf, retroover = builder.createRetroarchConfiguration()
    ...
    def test_write_config_to_file_new1610(self):
        builder = libretroConfigurations.LibretroConfiguration(self.wswan, self.onePlayerController, "/rom.rom", False, False, keyValueSettings("", False))
        builder.overrideLibretroConfigurationFiles(None, self.retroarchcustomFile)
        builder.createRetroarchConfiguration()
        reloaded = keyValueSettings(self.retroarchcustomFile, True)
        reloaded.loadFile(True)
    ...
    def test_create_with_ratio_custom(self):
        builder = libretroConfigurations.LibretroConfiguration(self.nescustomratio, self.onePlayerController, "/rom.rom", False, False, keyValueSettings("", False))
        builder.overrideLibretroConfigurationFiles(None, self.retroarchcustomFile)
        retroconf, retroover = builder.createRetroarchConfiguration()
        self.assertEquals(retroconf['video_aspect_ratio_auto'], 'false')
