...
define USBMOUNT_INSTALL_TARGET_CMDS
	$(SED) 's|^FILESYSTEMS=.*|FILESYSTEMS="vfat ext2 ext3 ext4 hfsplus ntfs"|g' $(@D)/usbmount.conf
	...
	mkdir -p $(addprefix $(TARGET_DIR)/recalbox/share/externals/usb,0 1 2 3 4 5 6 7)
endef
