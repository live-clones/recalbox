...
if [[ "${MERGE}" == 1 ]];then
    ...
    if [[ $(git ls-files -m | wc -l) != "0" ]];then
        ...
        git add package/recalbox-hardware/recalbox-hardware.mk package/recalbox-emulationstation2/recalbox-emulationstation2.mk package/recalbox-configgen/recalbox-configgen.mk package/recalbox-themes/recalbox-themes.mk | sed "s/^/\t/"
