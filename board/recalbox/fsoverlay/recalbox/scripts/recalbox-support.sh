...
f_cp /boot/recalbox-user-config.txt                           "${DSYSTEM}"
...
f_cp /recalbox/share_init/system/.emulationstation/systemlist.cfg "${DSYSTEM}/share_init_systemlist.cfg"
f_cp /recalbox/share/system/.emulationstation/systemlist.cfg "${DSYSTEM}/share_systemlist.cfg"
