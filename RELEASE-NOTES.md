...
## Version 8.2-patron-3

- Fix crash when exiting gameclip
- Add Raspberry Pi Touch Display support
- Fix screenshot delete during autoscrap,  prevent autoscrap for screenshots system
- Add Kodi resolution selection in Kodi Menu
- GPi2W full support
- Add PSX buttons styled help icons for 240p theme
- Global search & search in a particular system fixed and enhanced
- Fix bluetooth auto pairing on first boot
- Fix supermodel 3
- pcsx rearmed have pulse driver when starting a game on rrgbd
