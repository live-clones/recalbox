...
LIBRETRO_UAE_VERSION = 6bcad0b3f3fd19b4c4d35a4befd7bc9535f7410b
...
define LIBRETRO_UAE_BUILD_CMDS
	...
	$(SED) 's/kick33180.A500/kick33180.A500.rom/g' $(@D)/whdload/WHDLoad_files/S/KSCopy
	$(SED) 's/kick34005.A500/kick34005.A500.rom/g' $(@D)/whdload/WHDLoad_files/S/KSCopy
	$(SED) 's/kick40063.A600/kick40063.A600.rom/g' $(@D)/whdload/WHDLoad_files/S/KSCopy
	$(SED) 's/kick40068.A1200/kick40068.A1200.rom/g' $(@D)/whdload/WHDLoad_files/S/KSCopy
