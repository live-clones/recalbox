...
define RECALBOX_SYSTEM_INSTALL_TARGET_CMDS
	...
	cp package/recalbox/recalbox-system/$(RECALBOX_SYSTEM_RECALBOX_CONF)/recalbox.conf $(TARGET_DIR)/recalbox/share_init/system
	cp package/recalbox/recalbox-system/$(RECALBOX_SYSTEM_RECALBOX_CONF)/recalbox.conf $(TARGET_DIR)/recalbox/share_init/system/recalbox.conf.template
	# recalbox-boot.conf
        $(INSTALL) -D -m 0644 package/recalbox/recalbox-system/recalbox-boot.conf $(BINARIES_DIR)/$(RECALBOX_SYSTEM_SUBDIR)/recalbox-boot.conf
endef
