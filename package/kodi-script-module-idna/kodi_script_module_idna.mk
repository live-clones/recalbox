...
KODI_SCRIPT_MODULE_IDNA_RELEASE = matrix
KODI_SCRIPT_MODULE_IDNA_VERSION = 3.4.0
KODI_SCRIPT_MODULE_IDNA_PLUGIN_NAME = script.module.idna
KODI_SCRIPT_MODULE_IDNA_SOURCE = $(KODI_SCRIPT_MODULE_IDNA_PLUGIN_NAME)-$(KODI_SCRIPT_MODULE_IDNA_VERSION).zip
KODI_SCRIPT_MODULE_IDNA_SITE = https://mirrors.kodi.tv/addons/$(KODI_SCRIPT_MODULE_IDNA_RELEASE)/$(KODI_SCRIPT_MODULE_IDNA_PLUGIN_NAME)
