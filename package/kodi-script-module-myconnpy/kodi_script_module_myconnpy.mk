...
KODI_SCRIPT_MODULE_MYCONNPY_RELEASE = matrix
KODI_SCRIPT_MODULE_MYCONNPY_VERSION = 8.0.18+$(KODI_SCRIPT_MODULE_MYCONNPY_RELEASE).1
KODI_SCRIPT_MODULE_MYCONNPY_PLUGIN_NAME = script.module.myconnpy
KODI_SCRIPT_MODULE_MYCONNPY_SOURCE = $(KODI_SCRIPT_MODULE_MYCONNPY_PLUGIN_NAME)-$(KODI_SCRIPT_MODULE_MYCONNPY_VERSION).zip
KODI_SCRIPT_MODULE_MYCONNPY_SITE = https://mirrors.kodi.tv/addons/$(KODI_SCRIPT_MODULE_MYCONNPY_RELEASE)/$(KODI_SCRIPT_MODULE_MYCONNPY_PLUGIN_NAME)
