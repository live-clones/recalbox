...
KODI_SCRIPT_MODULE_REQUESTS_RELEASE = matrix
KODI_SCRIPT_MODULE_REQUESTS_VERSION = 2.27.1+$(KODI_SCRIPT_MODULE_REQUESTS_RELEASE).1
KODI_SCRIPT_MODULE_REQUESTS_PLUGIN_NAME = script.module.requests
KODI_SCRIPT_MODULE_REQUESTS_SOURCE = $(KODI_SCRIPT_MODULE_REQUESTS_PLUGIN_NAME)-$(KODI_SCRIPT_MODULE_REQUESTS_VERSION).zip
KODI_SCRIPT_MODULE_REQUESTS_SITE = https://mirrors.kodi.tv/addons/$(KODI_SCRIPT_MODULE_REQUESTS_RELEASE)/$(KODI_SCRIPT_MODULE_REQUESTS_PLUGIN_NAME)
