...
LIBRETRO_KRONOS_VERSION = 45da87b4d1beacb8d7034b06051b788ff9644672
...
define LIBRETRO_KRONOS_BUILD_CMDS
	...
	CFLAGS="$(TARGET_CFLAGS) $(COMPILER_COMMONS_CFLAGS_SO)" \
		...
		$(MAKE) CXX="$(TARGET_CXX)" CC="$(TARGET_CC)" AR="$(TARGET_AR)" LD="$(TARGET_LD)" RANLIB="$(TARGET_RANLIB)" -C $(@D)/yabause/src/libretro -f Makefile platform="$(RETROARCH_LIBRETRO_PLATFORM)" $(LIBRETRO_YABASANSHIRO_SUPP_OPT)
endef
