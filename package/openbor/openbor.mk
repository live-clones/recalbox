...
OPENBOR_VERSION = 126ccd77774ec7d3223aaae83aa8d1cf63b05d4c
...
define OPENBOR_BUILD_CMDS
	...
	CFLAGS="$(TARGET_CFLAGS) $(COMPILER_COMMONS_CFLAGS_SO) $(OPENBOR_PLATFORM_OPTS)" \
		...
		$(MAKE) RECALBOXSTRIP="$(TARGET_STRIP)" YASM="$(HOST_DIR)/bin/yasm" CXX="$(TARGET_CXX)" CC="$(TARGET_CC)" -C $(@D)/engine -f Makefile $(OPENBOR_BUILD_TARGET)=1 TARGET_GCC=$(TARGET_CXX) PNDDEV=$(STAGING_DIR)
endef
