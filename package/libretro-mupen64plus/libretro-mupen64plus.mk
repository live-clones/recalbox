...
LIBRETRO_MUPEN64PLUS_SUPP_OPT=FORCE_GLES=1 HAVE_NEON=1
ifeq ($(BR2_aarch64),y)
LIBRETRO_MUPEN64PLUS_SUPP_OPT += ARCH=aarch64 WITH_DYNAREC=aarch64
else
LIBRETRO_MUPEN64PLUS_SUPP_OPT += ARCH=arm WITH_DYNAREC=arm
endif
LIBRETRO_MUPEN64PLUS_PLATFORM=unix-gles
