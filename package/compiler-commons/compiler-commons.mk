...
COMPILER_COMMONS_GCC_LINKER_OPTIMIZATION_OPTIONS_LTO_EXECUTABLE += -flto=0 -fwhole-program -fuse-linker-plugin
COMPILER_COMMONS_GCC_LINKER_OPTIMIZATION_OPTIONS_LTO_LIBRARIES += -flto=0 -fuse-linker-plugin
endif
