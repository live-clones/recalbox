...
# ./scripts/linux/empack.py --force --system amigacd32 --extension '.uae .cue .CUE .ccd .CCD .iso .ISO .nrg .NRG .mds .MDS .zip .ZIP' --fullname 'Amiga CD32' --platform amigacd32 --theme amigacd32 1:amiberry:amiberry:BR2_PACKAGE_AMIBERRY
...
define CONFIGURE_MAIN_AMIGACD32_START
	$(call RECALBOX_ROMFS_CALL_ADD_SYSTEM,$(SYSTEM_XML_AMIGACD32),Amiga CD32,$(SYSTEM_NAME_AMIGACD32),.uae .cue .CUE .ccd .CCD .iso .ISO .nrg .NRG .mds .MDS .zip .ZIP,amigacd32,amigacd32)
endef
