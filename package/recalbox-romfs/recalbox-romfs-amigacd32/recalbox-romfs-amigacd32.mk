...
# ./scripts/linux/empack.py --force --system amigacd32 --extension '.uae .cue .ccd .iso .nrg .mds .m3u .chd .zip' --fullname 'Amiga CD32' --platform amigacd32 --theme amigacd32 1:amiberry:amiberry:BR2_PACKAGE_AMIBERRY 2:libretro:puae:BR2_PACKAGE_LIBRETRO_UAE 3:libretro:uae4arm:BR2_PACKAGE_LIBRETRO_UAE4ARM
...
define CONFIGURE_MAIN_AMIGACD32_START
	$(call RECALBOX_ROMFS_CALL_ADD_SYSTEM,$(SYSTEM_XML_AMIGACD32),Amiga CD32,$(SYSTEM_NAME_AMIGACD32),.uae .cue .ccd .iso .nrg .mds .m3u .chd .zip,amigacd32,amigacd32)
endef
...
define CONFIGURE_AMIGACD32_LIBRETRO_PUAE_DEF
	$(call RECALBOX_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_AMIGACD32),puae,2)
endef
endif

ifeq ($(BR2_PACKAGE_LIBRETRO_UAE4ARM),y)
define CONFIGURE_AMIGACD32_LIBRETRO_UAE4ARM_DEF
	$(call RECALBOX_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_AMIGACD32),uae4arm,3)
endef
endif
...
define RECALBOX_ROMFS_AMIGACD32_CONFIGURE_CMDS
	...
	$(CONFIGURE_AMIGACD32_LIBRETRO_UAE4ARM_DEF)
