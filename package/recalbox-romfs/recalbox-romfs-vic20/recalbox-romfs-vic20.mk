...
# ./scripts/linux/empack.py --force --system vic20 --extension '.20 .40 .60 .70 .a0 .b0 .bin .crt .prg .m3u .zip .7z' --fullname 'Commodore VIC-20' --platform vic20 --theme vic20 1:libretro:vice_xvic:BR2_PACKAGE_LIBRETRO_VICE
...
define CONFIGURE_MAIN_VIC20_START
	$(call RECALBOX_ROMFS_CALL_ADD_SYSTEM,$(SYSTEM_XML_VIC20),Commodore VIC-20,$(SYSTEM_NAME_VIC20),.20 .40 .60 .70 .a0 .b0 .bin .crt .prg .m3u .zip .7z,vic20,vic20)
endef
