...
# ./scripts/linux/empack.py --force --system mastersystem --extension '.sms .SMS .zip .ZIP .7z .7Z' --fullname 'Sega Master System / Mark III' --platform mastersystem --theme mastersystem 2:libretro:genesisplusgx:BR2_PACKAGE_LIBRETRO_GENESISPLUSGX 1:libretro:picodrive:BR2_PACKAGE_LIBRETRO_PICODRIVE 3:libretro:gearsystem:BR2_PACKAGE_LIBRETRO_GEARSYSTEM 4:libretro:fbneo:BR2_PACKAGE_LIBRETRO_FBNEO
...
ifneq ($(BR2_PACKAGE_LIBRETRO_GENESISPLUSGX)$(BR2_PACKAGE_LIBRETRO_PICODRIVE)$(BR2_PACKAGE_LIBRETRO_GEARSYSTEM)$(BR2_PACKAGE_LIBRETRO_FBNEO),)
...
define CONFIGURE_MASTERSYSTEM_LIBRETRO_GEARSYSTEM_DEF
	$(call RECALBOX_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_MASTERSYSTEM),gearsystem,3)
endef
endif

ifeq ($(BR2_PACKAGE_LIBRETRO_GENESISPLUSGX),y)
define CONFIGURE_MASTERSYSTEM_LIBRETRO_GENESISPLUSGX_DEF
	$(call RECALBOX_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_MASTERSYSTEM),genesisplusgx,2)
endef
endif

ifeq ($(BR2_PACKAGE_LIBRETRO_PICODRIVE),y)
define CONFIGURE_MASTERSYSTEM_LIBRETRO_PICODRIVE_DEF
	$(call RECALBOX_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_MASTERSYSTEM),picodrive,1)
endef
endif

ifeq ($(BR2_PACKAGE_LIBRETRO_FBNEO),y)
define CONFIGURE_MASTERSYSTEM_LIBRETRO_FBNEO_DEF
	$(call RECALBOX_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_MASTERSYSTEM),fbneo,4)
endef
endif
