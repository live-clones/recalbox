...
# ./scripts/linux/empack.py --system doom --extension '.wad .WAD .iwad .IWAD .pwad .PWAD .lmp .LMP' --fullname 'Doom' --platform doom --theme doom libretro:prboom:BR2_PACKAGE_LIBRETRO_PRBOOM
