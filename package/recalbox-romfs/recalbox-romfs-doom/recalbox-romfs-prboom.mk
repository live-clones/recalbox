...
# ./scripts/linux/empack.py --force --system doom --extension '.wad .WAD .iwad .IWAD .pwad .PWAD .lmp .LMP .pk4 .PK4 .zip .ZIP .7z .7Z' --fullname 'Doom' --platform doom --theme doom 1:libretro:prboom:BR2_PACKAGE_LIBRETRO_PRBOOM 2:libretro:boom3:BR2_PACKAGE_LIBRETRO_BOOM3
...
define CONFIGURE_MAIN_DOOM_START
	$(call RECALBOX_ROMFS_CALL_ADD_SYSTEM,$(SYSTEM_XML_DOOM),Doom,$(SYSTEM_NAME_DOOM),.wad .WAD .iwad .IWAD .pwad .PWAD .lmp .LMP .pk4 .PK4 .zip .ZIP .7z .7Z,doom,doom)
endef
