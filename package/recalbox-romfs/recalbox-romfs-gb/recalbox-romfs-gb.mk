...
define CONFIGURE_MAIN_GB_START
	$(call RECALBOX_ROMFS_CALL_ADD_SYSTEM,$(SYSTEM_XML_GB),Game Boy,$(SYSTEM_NAME_GB),.gb .zip .7z,gb,gb)
endef
...
define CONFIGURE_GB_LIBRETRO_MESEN_S_DEF
	$(call RECALBOX_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_GB),mesen_s,5)
endef
endif
...
define RECALBOX_ROMFS_GB_CONFIGURE_CMDS
	...
	$(CONFIGURE_GB_LIBRETRO_MESEN_S_DEF)
