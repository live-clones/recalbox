...
# ./scripts/linux/empack.py --system thomson --extension '.fd .FD .sap .SAP .k7 .K7 .m7 .M7 .rom .ROM .zip .ZIP' --fullname 'Thomson' --platform thomson --theme thomson libretro:theodore:BR2_PACKAGE_LIBRETRO_THEODORE
...
define CONFIGURE_MAIN_THOMSON_START
	$(call RECALBOX_ROMFS_CALL_ADD_SYSTEM,$(SYSTEM_XML_THOMSON),Thomson,$(SYSTEM_NAME_THOMSON),.fd .FD .sap .SAP .k7 .K7 .m7 .M7 .rom .ROM .zip .ZIP,thomson,thomson)
endef
