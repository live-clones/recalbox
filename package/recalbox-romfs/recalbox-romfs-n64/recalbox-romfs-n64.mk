...
# ./scripts/linux/empack.py --system n64 --extension '.n64 .N64 .z64 .Z64 .v64 .V64' --fullname 'Nintendo 64' --platform n64 --theme n64 mupen64plus:gliden64:BR2_PACKAGE_MUPEN64PLUS_GLIDEN64 mupen64plus:n64:BR2_PACKAGE_MUPEN64PLUS_GLES2 mupen64plus:rice:BR2_PACKAGE_MUPEN64PLUS_GLES2RICE mupen64plus:glide64mk2:BR2_PACKAGE_MUPEN64PLUS_VIDEO_GLIDE64MK2 libretro:glupen64:BR2_PACKAGE_LIBRETRO_GLUPEN64 libretro:mupen64plus_next:BR2_PACKAGE_LIBRETRO_MUPEN64PLUS_NEXT
...
endef
ifeq ($(BR2_PACKAGE_LIBRETRO_MUPEN64PLUS_NEXT),y)
define CONFIGURE_N64_LIBRETRO_MUPEN64PLUS_NEXT_DEF
	$(call RECALBOX_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_N64),mupen64plus_next)
endef
endif
