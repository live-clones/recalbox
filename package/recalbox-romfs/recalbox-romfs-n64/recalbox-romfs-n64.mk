...
# ./scripts/linux/empack.py --force --system n64 --extension '.n64 .z64  .v64 .bin .u1 .ndd .zip .7z' --fullname 'Nintendo 64' --platform n64 --theme n64 1:mupen64plus:gliden64:BR2_PACKAGE_MUPEN64PLUS_GLIDEN64 2:mupen64plus:n64_gles2:BR2_PACKAGE_MUPEN64PLUS_VIDEO_GLES2N64 3:mupen64plus:rice_gles2:BR2_PACKAGE_MUPEN64PLUS_VIDEO_GLES2RICE 4:mupen64plus:glide64mk2:BR2_PACKAGE_MUPEN64PLUS_VIDEO_GLIDE64MK2 5:libretro:mupen64plus:BR2_PACKAGE_LIBRETRO_MUPEN64PLUS 6:libretro:parallel_n64:BR2_PACKAGE_LIBRETRO_PARALLEL_N64 7:libretro:mupen64plus_next:BR2_PACKAGE_LIBRETRO_MUPEN64PLUS_NX 8:mupen64plus:rice:BR2_PACKAGE_MUPEN64PLUS_VIDEO_RICE
...
define CONFIGURE_N64_MUPEN64PLUS_RICE_DEF
	$(call RECALBOX_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_N64),rice,8)
endef
endif

ifeq ($(BR2_PACKAGE_MUPEN64PLUS_VIDEO_GLES2RICE),y)
define CONFIGURE_N64_MUPEN64PLUS_RICE_GLES2_DEF
	$(call RECALBOX_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_N64),rice_gles2,3)
endef
endif
...
define CONFIGURE_N64_MUPEN64PLUS_N64_GLES2_DEF
	$(call RECALBOX_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_N64),n64_gles2,2)
endef
endif
