...
# ./scripts/linux/empack.py --force --system n64 --extension '.n64 .N64 .z64 .Z64 .v64 .V64 .zip .ZIP .7z .7Z' --fullname 'Nintendo 64' --platform n64 --theme n64 1:mupen64plus:gliden64:BR2_PACKAGE_MUPEN64PLUS_GLIDEN64 2:mupen64plus:n64:BR2_PACKAGE_MUPEN64PLUS_GLES2N64 3:mupen64plus:rice:BR2_PACKAGE_MUPEN64PLUS_GLES2RICE 4:mupen64plus:glide64mk2:BR2_PACKAGE_MUPEN64PLUS_VIDEO_GLIDE64MK2 5:libretro:mupen64plus:BR2_PACKAGE_LIBRETRO_MUPEN64PLUS 6:libretro:parallel-n64:BR2_PACKAGE_PARALLEL_N64
...
ifneq ($(BR2_PACKAGE_MUPEN64PLUS_GLIDEN64)$(BR2_PACKAGE_MUPEN64PLUS_GLES2N64)$(BR2_PACKAGE_MUPEN64PLUS_GLES2RICE)$(BR2_PACKAGE_MUPEN64PLUS_VIDEO_GLIDE64MK2)$(BR2_PACKAGE_LIBRETRO_MUPEN64PLUS)$(BR2_PACKAGE_PARALLEL_N64),)
...
endef
ifeq ($(BR2_PACKAGE_PARALLEL_N64),y)
define CONFIGURE_N64_LIBRETRO_PARALLEL-N64_DEF
	$(call RECALBOX_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_N64),parallel-n64,6)
endef
endif
...
define RECALBOX_ROMFS_N64_CONFIGURE_CMDS
	...
	$(CONFIGURE_N64_LIBRETRO_PARALLEL-N64_DEF)
