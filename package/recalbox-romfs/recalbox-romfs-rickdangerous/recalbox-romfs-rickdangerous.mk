...
# ./scripts/linux/empack.py --force --port --readonly --system rickdangerous --extension '.zip .7z' --fullname 'Rick Dangerous' --platform rickdangerous --theme xrick 1:libretro:xrick:BR2_PACKAGE_LIBRETRO_XRICK
...
define CONFIGURE_MAIN_RICKDANGEROUS_START
	$(call RECALBOX_ROMFS_CALL_ADD_PORT,$(SYSTEM_XML_RICKDANGEROUS),Rick Dangerous,$(SYSTEM_NAME_RICKDANGEROUS),.zip .7z,rickdangerous,xrick,1)
endef
