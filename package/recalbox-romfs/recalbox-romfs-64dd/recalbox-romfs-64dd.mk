...
define CONFIGURE_64DD_LIBRETRO_MUPEN64PLUS_NEXT_DEF
	$(call RECALBOX_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_64DD),mupen64plus_next,2)
endef
endif
...
define RECALBOX_ROMFS_64DD_CONFIGURE_CMDS
	...
	$(CONFIGURE_64DD_LIBRETRO_MUPEN64PLUS_NEXT_DEF)
