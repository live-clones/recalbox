...
Put your satellaview roms in this directory.

Rom files must have a ".bs/.smc/.sfc/.zip/.7z" extension.
...
SatellaWave Data (SatData) can used if put uncompressed alongside the rom.
