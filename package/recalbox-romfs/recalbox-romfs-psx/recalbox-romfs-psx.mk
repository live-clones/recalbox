...
ifeq ($(BR2_PACKAGE_LIBRETRO_DUCKSTATION),y)
define CONFIGURE_PSX_LIBRETRO_DUCKSTATION_DEF
	$(call RECALBOX_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_PSX),duckstation,5)
endef
endif
...
define RECALBOX_ROMFS_PSX_CONFIGURE_CMDS
	...
	$(CONFIGURE_PSX_LIBRETRO_DUCKSTATION_DEF)
