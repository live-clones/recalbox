...
# ./scripts/linux/empack.py --force --system naomi --extension '.lst .LST .dat .DAT .zip .ZIP .7z .7Z' --fullname 'Sega NAOMI' --platform 'naomi arcade' --theme naomi 1:libretro:flycast:BR2_PACKAGE_LIBRETRO_FLYCAST
...
define CONFIGURE_MAIN_NAOMI_START
	$(call RECALBOX_ROMFS_CALL_ADD_SYSTEM,$(SYSTEM_XML_NAOMI),Sega NAOMI,$(SYSTEM_NAME_NAOMI),.lst .LST .dat .DAT .zip .ZIP .7z .7Z,naomi arcade,naomi)
endef
...
define CONFIGURE_NAOMI_LIBRETRO_FLYCAST_DEF
	$(call RECALBOX_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_NAOMI),flycast,1)
endef
endif
