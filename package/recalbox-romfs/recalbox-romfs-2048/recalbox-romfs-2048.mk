...
# ./scripts/linux/empack.py --force --port --readonly --system 2048 --extension '.game' --fullname '2048' --platform 2048 --theme 2048 1:libretro:2048:BR2_PACKAGE_LIBRETRO_2048
...
define CONFIGURE_MAIN_2048_START
	$(call RECALBOX_ROMFS_CALL_ADD_PORT,$(SYSTEM_XML_2048),2048,$(SYSTEM_NAME_2048),.game,2048,2048,1)
endef
