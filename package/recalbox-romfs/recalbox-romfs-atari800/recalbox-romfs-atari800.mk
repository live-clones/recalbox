...
# ./scripts/linux/empack.py --system atari800 --extension '.atr .ATR .bas .BAS .bin .BIN .car .CAR .dcm .DCM .xex .XEX .xfd .XFD .atr.gz .ATR.GZ .xfd.gz .XFD.GZ' --fullname 'Atari 800' --platform atari800 --theme atari800 libretro:atari800:BR2_PACKAGE_LIBRETRO_ATARI800
...
define CONFIGURE_MAIN_ATARI800_START
	$(call RECALBOX_ROMFS_CALL_ADD_SYSTEM,$(SYSTEM_XML_ATARI800),Atari 800,$(SYSTEM_NAME_ATARI800),.atr .ATR .bas .BAS .bin .BIN .car .CAR .dcm .DCM .xex .XEX .xfd .XFD .atr.gz .ATR.GZ .xfd.gz .XFD.GZ,atari800,atari800)
endef
