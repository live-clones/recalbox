...
# ./scripts/linux/empack.py --force --port --readonly --system mrboom --extension '.game' --fullname 'Mr. Boom' --platform mrboom --theme mrboom 1:libretro:mrboom:BR2_PACKAGE_LIBRETRO_MRBOOM
...
define CONFIGURE_MAIN_MRBOOM_START
	$(call RECALBOX_ROMFS_CALL_ADD_PORT,$(SYSTEM_XML_MRBOOM),Mr. Boom,$(SYSTEM_NAME_MRBOOM),.game,mrboom,mrboom,1)
endef
