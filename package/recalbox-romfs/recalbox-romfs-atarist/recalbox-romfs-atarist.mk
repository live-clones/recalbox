...
# ./scripts/linux/empack.py --force --system atarist --extension '.st .stx .ipf .msa .dim .zip .7z' --fullname 'Atari ST' --platform atarist --theme atarist 1:libretro:hatari:BR2_PACKAGE_LIBRETRO_HATARI
...
define CONFIGURE_MAIN_ATARIST_START
	$(call RECALBOX_ROMFS_CALL_ADD_SYSTEM,$(SYSTEM_XML_ATARIST),Atari ST,$(SYSTEM_NAME_ATARIST),.st .stx .ipf .msa .dim .zip .7z,atarist,atarist)
endef
