...
# ./scripts/linux/empack.py --force --system x68000 --extension '.dim .img .d88 .88d .hdm .dup .2hd .xdf .hdf .cmd .m3u .zip .7z' --fullname 'Sharp X68000' --platform x68000 --theme x68000 1:libretro:px68k:BR2_PACKAGE_LIBRETRO_PX68K
...
define CONFIGURE_MAIN_X68000_START
	$(call RECALBOX_ROMFS_CALL_ADD_SYSTEM,$(SYSTEM_XML_X68000),Sharp X68000,$(SYSTEM_NAME_X68000),.dim .img .d88 .88d .hdm .dup .2hd .xdf .hdf .cmd .m3u .zip .7z,x68000,x68000)
endef
