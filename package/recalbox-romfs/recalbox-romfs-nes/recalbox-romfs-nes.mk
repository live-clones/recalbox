...
ifneq ($(BR2_PACKAGE_LIBRETRO_NESTOPIA)$(BR2_PACKAGE_LIBRETRO_FCEUMM)$(BR2_PACKAGE_LIBRETRO_FCEUNEXT)$(BR2_PACKAGE_LIBRETRO_QUICKNES)$(BR2_PACKAGE_LIBRETRO_MESEN)$(BR2_PACKAGE_LIBRETRO_FBNEO),)
...
define CONFIGURE_NES_LIBRETRO_FBNEO_DEF
	$(call RECALBOX_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_NES),fbneo,6)
endef
endif
...
define RECALBOX_ROMFS_NES_CONFIGURE_CMDS
	...
	$(CONFIGURE_NES_LIBRETRO_FBNEO_DEF)
