...
# ./scripts/linux/empack.py --force --system snes --extension '.smc .sfc .swc .fig .mgd .zip .7z' --fullname 'Super Nintendo Entertainment System' --platform snes --theme snes 1:pisnes:pisnes:BR2_PACKAGE_PISNES 2:libretro:snes9x2002:BR2_PACKAGE_LIBRETRO_SNES9X2002 3:libretro:snes9x2005:BR2_PACKAGE_LIBRETRO_SNES9X2005 4:libretro:snes9x2010:BR2_PACKAGE_LIBRETRO_SNES9X2010 5:libretro:snes9x:BR2_PACKAGE_LIBRETRO_SNES9X 6:libretro:mesen_s:BR2_PACKAGE_LIBRETRO_MESEN_S
...
define CONFIGURE_SNES_LIBRETRO_MESEN_S_DEF
	$(call RECALBOX_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_SNES),mesen_s,6)
endef
endif
