...
# ./scripts/linux/empack.py --system snes --extension '.smc .sfc .SMC .SFC .mgd .MGD .zip .ZIP .7z .7Z' --fullname 'Super Nintendo Entertainment System' --platform snes --theme snes libretro:snes9x2005:BR2_PACKAGE_LIBRETRO_SNES9X2005 libretro:snes9x2002:BR2_PACKAGE_LIBRETRO_SNES9X2002 libretro:snes9x_next:BR2_PACKAGE_LIBRETRO_SNES9X_NEXT libretro:snes9x:BR2_PACKAGE_LIBRETRO_SNES9X
