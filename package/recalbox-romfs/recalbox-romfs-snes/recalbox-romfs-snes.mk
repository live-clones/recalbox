...
# ./scripts/linux/empack.py --force --system snes --extension '.smc .sfc .swc .fig .mgd .zip .7z' --fullname 'Super Nintendo Entertainment System' --platform snes --theme snes 1:pisnes:pisnes:BR2_PACKAGE_PISNES 2:libretro:snes9x:BR2_PACKAGE_LIBRETRO_SNES9X 3:libretro:mesen_s:BR2_PACKAGE_LIBRETRO_MESEN_S 4:libretro:snes9x2010:BR2_PACKAGE_LIBRETRO_SNES9X2010 5:libretro:snes9x2005:BR2_PACKAGE_LIBRETRO_SNES9X2005 6:libretro:snes9x2002:BR2_PACKAGE_LIBRETRO_SNES9X2002
...
ifneq ($(BR2_PACKAGE_PISNES)$(BR2_PACKAGE_LIBRETRO_SNES9X)$(BR2_PACKAGE_LIBRETRO_MESEN_S)$(BR2_PACKAGE_LIBRETRO_SNES9X2010)$(BR2_PACKAGE_LIBRETRO_SNES9X2005)$(BR2_PACKAGE_LIBRETRO_SNES9X2002),)
define CONFIGURE_MAIN_SNES_START
	$(call RECALBOX_ROMFS_CALL_ADD_SYSTEM,$(SYSTEM_XML_SNES),Super Nintendo Entertainment System,$(SYSTEM_NAME_SNES),.smc .sfc .swc .fig .mgd .zip .7z,snes,snes)
endef
...
define CONFIGURE_SNES_LIBRETRO_MESEN_S_DEF
	$(call RECALBOX_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_SNES),mesen_s,3)
endef
endif
...
define CONFIGURE_SNES_LIBRETRO_SNES9X2002_DEF
	$(call RECALBOX_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_SNES),snes9x2002,6)
endef
endif

ifeq ($(BR2_PACKAGE_LIBRETRO_SNES9X),y)
define CONFIGURE_SNES_LIBRETRO_SNES9X_DEF
	$(call RECALBOX_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_SNES),snes9x,2)
endef
endif

ifeq ($(BR2_PACKAGE_LIBRETRO_SNES9X2005),y)
define CONFIGURE_SNES_LIBRETRO_SNES9X2005_DEF
	$(call RECALBOX_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_SNES),snes9x2005,5)
endef
endif
...
define RECALBOX_ROMFS_SNES_CONFIGURE_CMDS
	...
	$(CONFIGURE_SNES_LIBRETRO_MESEN_S_DEF)
