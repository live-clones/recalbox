...
MUPEN_GLIDEN64_CXX_FLAGS = $(TARGET_CXXFLAGS)

ifeq ($(BR2_PACKAGE_RECALBOX_TARGETGROUP_ROCKCHIP),y)
	MUPEN64PLUS_GLIDEN64_CONF_OPTS += -DGLES2=On -DEGL=On -DUSE_SYSTEM_LIBS=On -DMUPENPLUSAPI=On 
	MUPEN_GLIDEN64_CXX_FLAGS += -march=armv8-a+crc
	ifeq ($(BR2_aarch64),)
		MUPEN64PLUS_GLIDEN64_CONF_OPTS += -DNEON_OPT=On
		MUPEN_GLIDEN64_CXX_FLAGS += -mfpu=neon -mfloat-abi=hard
	endif
endif

MUPEN64PLUS_GLIDEN64_CONF_OPTS += -DCMAKE_CXX_FLAGS="$(MUPEN_GLIDEN64_CXX_FLAGS)"
