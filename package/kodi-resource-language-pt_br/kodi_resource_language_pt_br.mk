################################################################################
#
# kodi portuguese brazil language resource
#
################################################################################

KODI_RESOURCE_LANGUAGE_PT_BR_RELEASE = matrix
KODI_RESOURCE_LANGUAGE_PT_BR_VERSION = 9.0.48
KODI_RESOURCE_LANGUAGE_PT_BR_PLUGINNAME = resource.language.pt_br
KODI_RESOURCE_LANGUAGE_PT_BR_SOURCE = $(KODI_RESOURCE_LANGUAGE_PT_BR_PLUGINNAME)-$(KODI_RESOURCE_LANGUAGE_PT_BR_VERSION).zip
KODI_RESOURCE_LANGUAGE_PT_BR_SITE = https://mirrors.kodi.tv/addons/$(KODI_RESOURCE_LANGUAGE_PT_BR_RELEASE)/$(KODI_RESOURCE_LANGUAGE_PT_BR_PLUGINNAME)
