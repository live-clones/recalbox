...
LIBRETRO_FLYCAST_SUPP_OPT += ARCH=x86 FORCE_GLES=1
else ifeq ($(BR2_PACKAGE_RECALBOX_TARGET_X86_64),y)
LIBRETRO_FLYCAST_SUPP_OPT += ARCH=x86_64 FORCE_GLES=1
...
LIBRETRO_FLYCAST_SUPP_OPT += ARCH=arm FORCE_GLES=1 CC_AS="$(TARGET_CC)"
endif
