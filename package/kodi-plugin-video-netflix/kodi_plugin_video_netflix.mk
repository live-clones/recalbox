...
KODI_PLUGIN_VIDEO_NETFLIX_VERSION = 1.20.5+$(KODI_PLUGIN_VIDEO_NETFLIX_RELEASE).1
KODI_PLUGIN_VIDEO_NETFLIX_PLUGINNAME = plugin.video.netflix
KODI_PLUGIN_VIDEO_NETFLIX_SOURCE = $(KODI_PLUGIN_VIDEO_NETFLIX_PLUGINNAME)-$(KODI_PLUGIN_VIDEO_NETFLIX_VERSION).zip
