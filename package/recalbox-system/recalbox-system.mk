...
RECALBOX_SYSTEM_VERSION=rk3328
RECALBOX_SYSTEM_RECALBOX_CONF=rk3328
RECALBOX_SYSTEM_SUBDIR=
else ifeq ($(BR2_PACKAGE_RECALBOX_TARGET_RK3399),y)
RECALBOX_SYSTEM_VERSION=rk3399
RECALBOX_SYSTEM_RECALBOX_CONF=rk3399
RECALBOX_SYSTEM_SUBDIR=
...
define RECALBOX_SYSTEM_INSTALL_TARGET_CMDS
	...
	# recalbox-boot.conf
	$(INSTALL) -D -m 0644 $(RECALBOX_SYSTEM_PKGDIR)/recalbox-boot.conf $(BINARIES_DIR)/$(RECALBOX_SYSTEM_SUBDIR)/recalbox-boot.conf
endef
