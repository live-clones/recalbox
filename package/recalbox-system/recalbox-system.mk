...
define RECALBOX_SYSTEM_INSTALL_RPI_CONFIG
	$(INSTALL) -D -m 0644 $(RECALBOX_SYSTEM_PKGDIR)/$(RECALBOX_SYSTEM_RECALBOX_CONF)/config.txt $(BINARIES_DIR)/$(RECALBOX_SYSTEM_FIRMWAREDIR)/config.txt
	$(INSTALL) -D -m 0644 $(RECALBOX_SYSTEM_PKGDIR)/recalbox-config.txt $(BINARIES_DIR)/$(RECALBOX_SYSTEM_FIRMWAREDIR)/recalbox-config.txt
endef
endif
