...
LIBRETRO_BEETLE_PSX_HW_VERSION = 1f4e633d590da48f8ad622b8e6a699142710e6f6
...
define LIBRETRO_BEETLE_PSX_HW_BUILD_CMDS
	...
	CFLAGS="$(TARGET_CFLAGS) $(COMPILER_COMMONS_CFLAGS_SO)" \
		...
		$(MAKE) CXX="$(TARGET_CXX)" CC="$(TARGET_CC)" -C $(@D)/ -f Makefile platform="$(RETROARCH_LIBRETRO_PLATFORM)" HAVE_HW=1 HAVE_CDROM=1
endef
