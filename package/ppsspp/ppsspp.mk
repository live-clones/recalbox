...
PPSSPP_VERSION = b0a163ba2e0717e77a9f4a439ce1c5ad702940aa
...
PPSSPP_CONF_OPTS += \
	...
	-DUSING_X11_VULKAN=NO \
	-DUSING_GLES2=1
PPSSPP_CONF_OPTS += -DCMAKE_C_FLAGS="$(COMPILER_COMMONS_CFLAGS_NOLTO) -DEGL_NO_X11"
PPSSPP_CONF_OPTS += -DCMAKE_CXX_FLAGS="$(COMPILER_COMMONS_CXXFLAGS_NOLTO) -DEGL_NO_X11"
else
PPSSPP_CONF_OPTS += -DCMAKE_C_FLAGS="$(COMPILER_COMMONS_CFLAGS_NOLTO)"
PPSSPP_CONF_OPTS += -DCMAKE_CXX_FLAGS="$(COMPILER_COMMONS_CXXFLAGS_NOLTO)"
endif
...
PPSSPP_CONF_OPTS += -DCMAKE_LINKER_EXE_FLAGS="$(COMPILER_COMMONS_LDFLAGS_NOLTO)"
