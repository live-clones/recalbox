...
PPSSPP_CONF_OPTS += -DCMAKE_C_FLAGS="$(COMPILER_COMMONS_CFLAGS_EXE) -DEGL_NO_X11 -funsafe-math-optimizations"
PPSSPP_CONF_OPTS += -DCMAKE_CXX_FLAGS="$(COMPILER_COMMONS_CXXFLAGS_EXE) -DEGL_NO_X11 -funsafe-math-optimizations"
else
